...
**Expiration Dates**: All assignments have a hard deadline. If you are unable to submit an assignment on time, you may use a token to extend the deadline by one week. Tokens must be applied before the original due date of the assignment. After the original due date, no extensions will be granted except in cases of documented severe and/or extenuating circumstances.
